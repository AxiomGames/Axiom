...
namespace Ax
{
	...
	public:
		...
		[[nodiscard]] __forceinline bool Any() const { return m_Size > 0; }
		[[nodiscard]] __forceinline bool Empty() const { return m_Size == 0; }
		...
		[[nodiscard]] __forceinline uint32_t Size() const { return m_Size; }
		[[nodiscard]] __forceinline uint32_t DataSize() const { return m_Size * sizeof(T); }
